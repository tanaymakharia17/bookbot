...
CSRF_TRUSTED_ORIGINS = [
    ...
    for o in os.environ.get(
        "CSRF_TRUSTED_ORIGINS",
        "http://localhost:8500,http://localhost:8000,http://localhost:8501",
    ).split(",")
    if o.strip()
]
...
DATABASES = {
    "default": dj_database_url.config(
        default=os.environ.get(
            "DATABASE_URL", "postgres://bookbot:bookbot@postgres:5432/bookbot"
        ),
        conn_max_age=600,
    )
}
...
CAPEX_THRESHOLD = Decimal(os.environ.get("CAPEX_THRESHOLD", "2500.00"))
OPENROUTER_API_KEY = os.environ.get("OPENROUTER_API_KEY", "")
OPENROUTER_BASE_URL = os.environ.get("OPENROUTER_BASE_URL", "https://openrouter.ai/api/v1")
VLM_MODEL = os.environ.get("VLM_MODEL", "qwen/qwen3.7-flash")
